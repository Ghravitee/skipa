  ...
  return (
    <section className="py-20 linear">
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-2 gap-6">
        <h2 className="text-5xl sm:text-6xl text-center text-white my-6 font-bold font1 lg:hidden font-edo">
          SKIPANOMICS
        </h2>
        ...
        <div className="flex flex-col gap-4 justify-center mx-auto">
          <mh2 className="text-7xl text-white my-6 font-bold hidden lg:block font-edo">
            SKIPANOMICS
          </mh2>
